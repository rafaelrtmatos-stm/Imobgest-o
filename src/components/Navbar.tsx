  ...
  const menuItems = [
    {
      ...
      label: 'Dashboard',
      description: 'Métricas, totais e visão geral dos contratos',
    ...
    },
    {
      ...
      description: 'Emissão de Contratos (À Vista, Parcelado, Exclusividade e Word .docx)',
      icon: FileText,
    ...
    },
    {
      ...
      label: 'Relatório de Vendas (Contratos)',
      description: 'Extrato detalhado do que foi vendido pelos contratos gerados',
      icon: ListFilter,
    ...
    },
    {
      ...
      description: 'Controle de corretores e valores de comissão',
      icon: DollarSign,
      color: 'text-emerald-500 bg-emerald-500/10 border-emerald-500/30',
    ...
    ...(isAdmin ? [{
      ...
      description: 'Adicionar e gerenciar equipe e acessos',
      icon: UserCog,
    ...
    }] : []),
    {
      ...
      label: 'Configurações & Nuvem',
      description: 'Sincronização em tempo real no Supabase e dados da empresa',
      icon: Settings,
